...
image_test_folder = os.path.join(get_parent_dir(n=1), "images")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        dest="classes_path",
        default=model_classes1,
        help="Path to YOLO class specifications. Default is " + model_classes1,
    )
    ...
    if input_image_paths:
        ...
        innerFolder = get_parent_dir(1) + "/images/innerFolder"
        
        bb_list = out_df.values.tolist()
        for bb in bb_list:
            crop_image(bb[1], bb[2:6], innerFolder)
